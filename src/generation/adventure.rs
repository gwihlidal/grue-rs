...
impl Adventures {
	pub fn random_theme(&self) -> (String, String) {
		if !self.themes.is_empty() {
			...
			(
				self.themes[choice].name.to_string(),
				self.themes[choice].desc.to_string(),
			)
		} else {
	...
	pub fn random_goal(&self) -> (String, String) {
		if !self.goals.is_empty() {
			...
			(
				self.goals[choice].name.to_string(),
				self.goals[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_story_hook(&self) -> (String, String) {
		if !self.story_hooks.is_empty() {
			...
			(
				self.story_hooks[choice].name.to_string(),
				self.story_hooks[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_plot(&self) -> (String, String) {
		if !self.plots.is_empty() {
			...
			(
				self.plots[choice].name.to_string(),
				self.plots[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_climax(&self) -> (String, String) {
		if !self.climaxes.is_empty() {
			...
			(
				self.climaxes[choice].name.to_string(),
				self.climaxes[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_general_setting(&self) -> (String, String) {
		if !self.general_settings.is_empty() {
			...
			(
				self.general_settings[choice].name.to_string(),
				self.general_settings[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_specific_setting(&self) -> (String, String) {
		if !self.specific_settings.is_empty() {
			...
			(
				self.specific_settings[choice].name.to_string(),
				self.specific_settings[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_master_villain(&self) -> (String, String) {
		if !self.master_villains.is_empty() {
			...
			(
				self.master_villains[choice].name.to_string(),
				self.master_villains[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_minor_villain(&self) -> (String, String) {
		if !self.minor_villains.is_empty() {
			...
			(
				self.minor_villains[choice].name.to_string(),
				self.minor_villains[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_ally_neutral(&self) -> (String, String) {
		if !self.allies_neutral.is_empty() {
			...
			(
				self.allies_neutral[choice].name.to_string(),
				self.allies_neutral[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_monster_encounter(&self) -> (String, String) {
		if !self.monster_encounters.is_empty() {
			...
			(
				self.monster_encounters[choice].name.to_string(),
				self.monster_encounters[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_character_encounter(&self) -> (String, String) {
		if !self.character_encounters.is_empty() {
			...
			(
				self.character_encounters[choice].name.to_string(),
				self.character_encounters[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_death_trap(&self) -> (String, String) {
		if !self.death_traps.is_empty() {
			...
			(
				self.death_traps[choice].name.to_string(),
				self.death_traps[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_chase(&self) -> (String, String) {
		if !self.chases.is_empty() {
			...
			(
				self.chases[choice].name.to_string(),
				self.chases[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_omen_prophecy(&self) -> (String, String) {
		if !self.omens_prophecies.is_empty() {
			...
			(
				self.omens_prophecies[choice].name.to_string(),
				self.omens_prophecies[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_secret_weakness(&self) -> (String, String) {
		if !self.secret_weaknesses.is_empty() {
			...
			(
				self.secret_weaknesses[choice].name.to_string(),
				self.secret_weaknesses[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_special_condition(&self) -> (String, String) {
		if !self.special_conditions.is_empty() {
			...
			let choice = rng.gen_range(0..self.omens_prophecies.len());
			(
				self.special_conditions[choice].name.to_string(),
				self.special_conditions[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_moral_quandary(&self) -> (String, String) {
		if !self.moral_quandaries.is_empty() {
			...
			(
				self.moral_quandaries[choice].name.to_string(),
				self.moral_quandaries[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_red_herring(&self) -> (String, String) {
		if !self.red_herrings.is_empty() {
			...
			(
				self.red_herrings[choice].name.to_string(),
				self.red_herrings[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
	...
	pub fn random_cruel_trick(&self) -> (String, String) {
		if !self.cruel_tricks.is_empty() {
			...
			(
				self.cruel_tricks[choice].name.to_string(),
				self.cruel_tricks[choice].desc.to_string(),
			)
		} else {
			(String::default(), String::default())
		}
